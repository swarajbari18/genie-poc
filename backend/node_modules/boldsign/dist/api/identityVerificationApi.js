...
exports.IdentityVerificationApi = void 0;
...
class IdentityVerificationApi {
    ...
    createEmbeddedVerificationUrl(documentId_1, embeddedFileDetails_1) {
        return __awaiter(this, arguments, void 0, function* (documentId, embeddedFileDetails, options = { headers: {} }) {
            ...
            const result = (0, _1.generateFormData)(embeddedFileDetails, model_1.EmbeddedFileDetails);
            ...
            if (localVarUseFormData) {
                ...
                data = model_1.ObjectSerializer.serialize(embeddedFileDetails, "EmbeddedFileDetails");
            }
            ...
            return interceptorPromise.then(() => {
                return new Promise((resolve, reject) => {
                    axios_1.default.request(localVarRequestOptions)
                        .then((response) => {
                        handleSuccessfulResponse(resolve, reject, response, "EmbeddedFileLink");
                    }, (error) => {
                        if (error.response == null) {
                            reject(error);
                            return;
                        }
                        if (handleErrorCodeResponse(reject, error.response, 200, "EmbeddedFileLink")) {
                            return;
                        }
    ...
    image(documentId_1, downloadImageRequest_1) {
        return __awaiter(this, arguments, void 0, function* (documentId, downloadImageRequest, options = { headers: {} }) {
            ...
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            const result = (0, _1.generateFormData)(downloadImageRequest, model_1.DownloadImageRequest);
            localVarUseFormData = result.localVarUseFormData;
            let data = {};
            if (localVarUseFormData) {
                const formData = (0, _1.toFormData)(result.data);
                ...
                data = model_1.ObjectSerializer.serialize(downloadImageRequest, "DownloadImageRequest");
            }
            let localVarRequestOptions = {
                method: 'POST',
                params: localVarQueryParameters,
    ...
    report(documentId_1, verificationDataRequest_1) {
        return __awaiter(this, arguments, void 0, function* (documentId, verificationDataRequest, options = { headers: {} }) {
            ...
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            const result = (0, _1.generateFormData)(verificationDataRequest, model_1.VerificationDataRequest);
            localVarUseFormData = result.localVarUseFormData;
            let data = {};
            if (localVarUseFormData) {
                const formData = (0, _1.toFormData)(result.data);
                ...
                data = model_1.ObjectSerializer.serialize(verificationDataRequest, "VerificationDataRequest");
            }
            let localVarRequestOptions = {
                method: 'POST',
                params: localVarQueryParameters,
            ...
            return interceptorPromise.then(() => {
                return new Promise((resolve, reject) => {
                    axios_1.default.request(localVarRequestOptions)
                        .then((response) => {
                        handleSuccessfulResponse(resolve, reject, response, "IdReport");
                    }, (error) => {
                        if (error.response == null) {
                            reject(error);
                            return;
                        }
                        if (handleErrorCodeResponse(reject, error.response, 200, "IdReport")) {
                            return;
                        }
                        if (handleErrorCodeResponse(reject, error.response, 401, "ErrorResult")) {
                            return;
...
exports.IdentityVerificationApi = IdentityVerificationApi;
...
//# sourceMappingURL=identityVerificationApi.js.map