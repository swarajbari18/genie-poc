...
describe('Template API Test suite', () => {
    ...
    test('Test42: should send document for signing using multiple templates', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        role.authenticationCode = '123456';
        role.authenticationSettings = {
            authenticationFrequency: model_1.AuthenticationSettings.AuthenticationFrequencyEnum.OncePerDocument
        };
        role.signerRole = "Manager";
        role.formFields = [formField];
    ...
    test('Test43:should create embedded request URL from merged templates', () => __awaiter(void 0, void 0, void 0, function* () {
        const role1 = new model_1.Role();
        role1.signerEmail = 'sivaramani.sivaraj@syncfusion.com';
        role1.signerName = 'sivaramani';
        role1.signerType = model_1.Role.SignerTypeEnum.Signer;
        role1.authenticationType = model_1.Role.AuthenticationTypeEnum.AccessCode;
        ...
        role1.signerOrder = 1;
        role1.roleIndex = 1;
        const role2 = new model_1.Role();
        role2.signerEmail = 'david@gmail.com';
        role2.signerName = 'david';
        role2.signerType = model_1.Role.SignerTypeEnum.Signer;
        role2.signerRole = 'Team Lead';
        role2.signerOrder = 2;
        role2.roleIndex = 2;
        const fileStream = fs.createReadStream('tests/documents/agreement.pdf');
        const request = new model_1.EmbeddedMergeTemplateFormRequest();
        ...
        try {
            const response = yield templateApi.mergeCreateEmbeddedRequestUrlTemplate(request);
            expect(response).toBeDefined();
    ...
    test('Test44: should fail to create embedded request URL from merged templates with invalid template IDs', () => __awaiter(void 0, void 0, void 0, function* () {
        const role1 = new model_1.Role();
        role1.signerEmail = 'sivaramani.sivaraj@syncfusion.com';
        role1.signerName = 'sivaramani';
        role1.signerType = model_1.Role.SignerTypeEnum.Signer;
    ...
    test('Test45:should delete template successfully', () => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    test('Test46:should fail to delete template with invalid template ID', () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const invalidTemplateId = "INVALID_TEMPLATE_ID";
