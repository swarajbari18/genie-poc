...
describe('PlanApi Unit Test', () => {
    let planApiStub;
    beforeEach(() => {
        planApiStub = sinon.createStubInstance(planApi_1.PlanApi);
    ...
    it('should mock and verify getBalanceDocumentCredits call', () => __awaiter(void 0, void 0, void 0, function* () {
        const expectedBalance = {
            balanceCredits: 150,
        };
        const result = yield planApiStub.getBalanceDocumentCredits();
        expect(result).toBeDefined();
        expect(result.balanceCredits).toBe(150);
        sinon.assert.calledOnce(planApiStub.getBalanceDocumentCredits);
    }));
});
//# sourceMappingURL=planApi.spec.js.map